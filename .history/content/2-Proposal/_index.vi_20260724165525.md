...
Ứng dụng kiến trúc không máy chủ, event driven và AI (Amazon Bedrock) trong một hệ thống thực tế, đáp ứng các nguyên tắc của AWS Well Architected (chi phí, bảo mật, độ sẵn sàng, vận hành).
