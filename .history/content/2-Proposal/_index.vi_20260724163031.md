...
Tên đề tài: AI Personal Learning Journal Platform – Nền tảng nhật ký học tập cá nhân tích hợp AI (kiến trúc serverless).

Đề tài xây dựng một nền tảng web giúp người học ghi nhật ký học tập hàng ngày, kèm text và ảnh minh họa, sau đó dùng AI để phân tích, tổng hợp và tạo báo cáo tuần/tháng về tiến độ học tập, điểm mạnh – điểm yếu, thói quen học và gợi ý cải thiện.
...
![Kiến trúc AI Personal Learning](../../images/2-Proposal/ai_personal_learning_architecture.png)
