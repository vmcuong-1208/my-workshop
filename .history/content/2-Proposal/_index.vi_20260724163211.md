...
Đề tài xây dựng một nền tảng web giúp người học ghi nhật ký học tập hàng ngày, kèm text và đính kèm ảnh, sau đó dùng AI để phân tích, tổng hợp và tạo báo cáo tuần/tháng về tiến độ học tập, điểm mạnh – điểm yếu, thói quen học và gợi ý cải thiện, quiz ôn tập, tìm kiếm và thống kê tiến độ.
