...
##### - o	Người dùng có thể ghi nhật ký học tập (text + ảnh), được AI phân tích và tóm tắt thành báo cáo tuần/tháng, giúp nhìn lại hành trình học một cách có cấu trúc.
