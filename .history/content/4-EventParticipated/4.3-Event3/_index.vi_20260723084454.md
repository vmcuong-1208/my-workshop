...
- **Bài học rút ra**
  - Kiến trúc cho game multiplayer thực ra là hai kiến trúc khác nhau — session-based (độ trễ thấp, trạng thái tạm thời) và persistent-world (stateful, nặng AI). Chọn sai một trong hai là sai lầm kéo dài nhiều năm; chọn đúng từ đầu sẽ làm mọi thứ phía sau dễ hơn rất nhiề.
