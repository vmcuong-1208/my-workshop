...
- **Kỹ năng mới tiếp thu được**
  ...
  - Kỹ năng mềm: nghe tốt hơn trong một bài nói lai giữa hạ tầng, networking và phân tích dữ liệu; ghi chú có cấu trúc để tách riêng kiến trúc, chi phí, bảo mật và xu hướng tương lai; đặt câu hỏi rõ hơn về cách triển khai các mẫu này ở quy mô sinh viên [file:2].
